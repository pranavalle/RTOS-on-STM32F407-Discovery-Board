...
extern TaskHandle_t handle_echo_task;
extern TaskHandle_t handle_trig_task;

extern QueueHandle_t q_echo_data;
...
extern void trig_task(void* param);
extern void echo_task(void* param);
